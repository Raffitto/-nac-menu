...
function expectedCalendarDays(startDate?: string | null, endDate?: string | null) {
...
type CoverageAggregation = {
  dayCount?: number;
  dailyBreakdown?: { date: string; totalSales?: number | null; totalDeliverySales?: number | null; totalDeliveryOrders?: number | null }[];
...
export function assessPeriodCoverage({
  ...
  let completeness: "complete" | "partial" | "unavailable" = "unavailable";
...
export function buildCoverageAnswerLines(coverageAssessment: ReturnType<typeof assessPeriodCoverage> | null) {
...
function capitalizeConfidence(level: string) {
