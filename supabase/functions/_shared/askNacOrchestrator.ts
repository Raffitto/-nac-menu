...
export async function processAskNacOnEdge(
  ...
  if (useFabricSpine) {
    ...
    return attachResponseMeta({
      ...
      recommendations: [],
      confidence: spine.answerConfidence === "limitation" || spine.answerConfidence === "low"
        ? "none"
        : spine.answerConfidence === "medium"
          ? "medium"
          : spine.answerConfidence === "high"
            ? "high"
            : (spine.state.answer.verified ? "high" : "medium"),
      ...
      companyIntelligence: {
        ...
        executionVerification: spine.executionVerification || null,
        evidenceCompleteness: spine.evidenceCompleteness || null,
        answerConfidence: spine.answerConfidence || null,
      },
      executionVerification: spine.executionVerification || null,
      evidenceCompleteness: spine.evidenceCompleteness || null,
      answerConfidence: spine.answerConfidence || null,
