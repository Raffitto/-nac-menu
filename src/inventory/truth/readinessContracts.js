...
export const SOURCE_EVIDENCE_CLASS = Object.freeze({
  SOURCE_CONFIRMED_CURRENT: "SOURCE_CONFIRMED_CURRENT",
  SOURCE_CONFIRMED_WITH_DIFFERENCES: "SOURCE_CONFIRMED_WITH_DIFFERENCES",
  MULTIPLE_SOURCE_CONFLICT: "MULTIPLE_SOURCE_CONFLICT",
  DATABASE_DRAFT_NEWER_THAN_SOURCE: "DATABASE_DRAFT_NEWER_THAN_SOURCE",
  SOURCE_NEWER_THAN_DATABASE: "SOURCE_NEWER_THAN_DATABASE",
  NO_SOURCE_EVIDENCE: "NO_SOURCE_EVIDENCE",
  BROKEN_RECIPE: "BROKEN_RECIPE",
  IDENTITY_MAPPING_PROBLEM: "IDENTITY_MAPPING_PROBLEM",
...
export const COMMERCE_IDENTITY_CLASS = Object.freeze({
  ...
  EXACT_FOODICS_PRODUCT_NAME_MATCH: "EXACT_FOODICS_PRODUCT_NAME_MATCH",
  FOODICS_PRODUCT_NAME_AMBIGUOUS: "FOODICS_PRODUCT_NAME_AMBIGUOUS",
});
