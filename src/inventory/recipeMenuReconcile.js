...
export const RECIPE_NAME_ALIASES = Object.freeze([
  ["big nac v2", "big nac"],
  ["big nac", "big nac v2"],
  ["prawn rendang grilled lemon", "king prawn rendang"],
  ["prawn rendang grilled lemon", "prawn rendang"],
  ["king prawn rendang", "prawn rendang"],
  ["sea bass creole with pepper cream sauce n a", "pan seared seabass"],
  ["sea bass creole with pepper cream sauce", "pan seared seabass"],
  ["sea bass in baking sheet", "pan seared seabass"],
  ["sea bass in papillote zucchini lemon", "pan seared seabass"],
  ["watermelon cucumber feta pine nuts balsamic dressing", "watermelon cucumber"],
  ["chocolate brownie with cookie chunk caramel", "brownie caramel vanilla ice cream"],
  ...
  ["shakshuka poached eggs feta za atar pita", "shakshuka"],
  ["quinoa pomegranate baby tomato lemon confit dressing", "quinoa"],
  ["quinoa pomegranate baby tomato lemon confit dressing lunch", "quinoa"],
  ["mushroom toat hazelnut salt", "mushroom toast"],
  ["mushroom toast hazelnut salt", "mushroom toast"],
  ["corn truffle risotto", "corn white truffle risotto"],
  ["corn risotto", "corn white truffle risotto"],
  ["black angus black peppercorn", "black angus steak au poivre"],
  ["pavlova strawberry", "strawberry pistachio pavlova"],
  ["pavlova", "strawberry pistachio pavlova"],
  ["kale cabbage parmigiano pine nuts golden raisins honey za atar dressing", "kale cabbage"],
  ["lunch kale cabbage parmigiano pine nuts golden raisins honey za atar dressing da", "kale cabbage"],
  ["lunch kale cabbage parmigiano pine nuts golden raisins honey za atar dressing", "kale cabbage"],
]);
