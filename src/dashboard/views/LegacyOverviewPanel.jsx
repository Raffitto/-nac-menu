...
import { formatSupabaseSetupMessage } from "../../lib/platformAuth";
...
/**
 * Legacy Overview operations panel (opt-out of unified overview).
 * Separate chunk so nac-os cold boot never downloads this recharts path.
 */
export default function LegacyOverviewPanel(props) {
  const {
    session,
    configured,
    rbacEnvInvalid,
