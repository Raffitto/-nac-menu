...
export async function registerVaultUpload(supabase, { file, metadata, session, profile }) {
  ...
  const row = {
    ...
    knowledge_domain: mergedMetadata.knowledgeDomain || null,
    knowledge_subdomain: mergedMetadata.knowledgeSubdomain || null,
    artifact_type: mergedMetadata.artifactType || null,
    authority_level: mergedMetadata.authorityLevel || "uploaded_report",
